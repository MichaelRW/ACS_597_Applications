...
For these muffler comparisons, it is assumed that there is no resistive terms (i.e., damping) and no flow.

   
\subsection*{Problem 2a}

Figure~\ref{figure:problem2figure1} shows the transmission loss profiles for the 

There is no damping in the system;  resonances will be artificially high.

Transmission loss - End corrections;  no physical meaning.
