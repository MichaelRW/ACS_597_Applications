...
Table~\ref{table:holePlacementSummary} summarizes the 
...
\begin{table}[h!]
    \begin{center}
        ...
        \end{tabular}
    \end{center}
    \caption{Measured $L_{Slow,A}$ sound pressure levels.  Distance between the SLM and sound source was approximately 0.3 meters.  The sound level of the quiet room was approximately 30.0 dB SPL A.}
