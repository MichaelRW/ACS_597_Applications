...
\vspace{-0.25cm}
Figure~\ref{figure:1bDirectivityPatterns} illustrates the directivity patterns for a monopole, dipole, lateral quadrupole, and a linear quadrupole for 1 kHz.  The receivers are placed at a 1 $m$ distance around the sources.
