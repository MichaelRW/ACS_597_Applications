...
%% Problem 2c - Finite Line Source - 4 Sources Uniformly Separation - Less than a Wavelength
...
array_length = ( size( xyz_sources, 1 ) - 1 )*d;  % 0.343 m
...
%% Problem 2c - Finite Line Source - 4 Sources Uniformly Separation - 1 kHz Wavelength Separation
...
array_length = ( size( xyz_sources, 1 ) - 1 )*d;  % 1.37 m
...
figure( 'Name', 'Baffled Piston - ka = 8' ); ...
    ...
    line( [ r_null(4) r_null(4) ], [ 25 75 ], 'Color', [ 1, 0, 0, 0.5 ] );
    line( [ r_null(5) r_null(5) ], [ 25 75 ], 'Color', [ 1, 0, 0, 0.5 ] );  grid on;
