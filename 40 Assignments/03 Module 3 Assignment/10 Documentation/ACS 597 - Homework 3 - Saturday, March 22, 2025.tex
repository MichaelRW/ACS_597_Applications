...
\begin{figure}[htpb!]
    \center
        \includegraphics[scale = 0.8, keepaspectratio, trim=4 4 4 4, clip]{Homework_3_Part_2c.pdf}
    \vspace{0.25cm}    
...
\begin{figure}[htpb!]
    \center
        \includegraphics[scale = 0.8, keepaspectratio, trim=4 4 4 4, clip]{Homework_3_Part_2d.pdf}
    \vspace{0.25cm}
