...
\vspace{0.25cm}
Figure~\ref{figure:2aDiagramTwoStageMount} illustrates the two stage mount considered here.

\vspace{-0.25cm}
\begin{figure}[htb!]
    \center
        \includegraphics[scale = 0.7, keepaspectratio]{ACS 547 - Homework 3, Problem 2.pdf}
    \vspace{-0.2cm}
    \caption{Two-stage washing machine mount system.}
