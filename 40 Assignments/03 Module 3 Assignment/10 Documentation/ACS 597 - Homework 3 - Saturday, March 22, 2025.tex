...
Table~\ref{table:3Parameters} lists the initial stiffness and damping coefficients for the system.
...
Figure~\ref{figure:3aEquationsFromDvaLecture} shows the admittance responses of the original system and DVA system based on the equations presented in the tutorial lecture on DVA system analysis.
...
A DVA is used at a specific operating frequency, here it is 300 RPM or 5 Hz.



\subsection*{Part 3c}

Figure~\ref{figure:3bAdmittance} ph
