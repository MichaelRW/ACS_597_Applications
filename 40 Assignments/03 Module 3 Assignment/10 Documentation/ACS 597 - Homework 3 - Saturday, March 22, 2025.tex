...
\vspace{0.25cm}
Figure~\ref{figure:loadForceVersusRPM} shows the load force produced by the 1 kg imbalanced mass at a 0.5 m radius from the center of the washing machine as a function of angular speed in RPM.
