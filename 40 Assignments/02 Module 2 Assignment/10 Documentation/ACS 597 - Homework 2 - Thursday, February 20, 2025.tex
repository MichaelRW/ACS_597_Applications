...
Table~\ref{table:targetInsertionLosses} lists target insertion losses, the calculated insertion losses per material type, and the difference between target and calculated.  A positive value indicates that the target insertion loss for the given octave band was not meet.
...
\begin{table}[h!]
    \begin{center}
        ...
        \begin{tabular}{ | c | c | c | c | c | c |}
            \hline
            \textbf{Octave Band [Hz]}  &  \textbf{Target IL [dB]}  &  \textbf{Case 1 [dB]}  &  \textbf{Case 2 [dB]}  &  \textbf{Case 3 [dB]}  &  \textbf{Case 4 [dB]}  \\
            \hline
        ...
        \end{tabular}
    \end{center}
    \caption{Calculated insertion loss differences with the alpha correction to 0.99}
...
% Case 3 - https://www.acousticsworld.com/machine-acoustic-enclosures/
% Case 4 - In class table.



Figure~\ref{figure:q5CNcaseData} shows the transmission loss and absorption coefficients for the material selected from Control Noise.
...
Figure~\ref{figure:q5AWcaseData} shows the transmission loss and absorption coefficients for the material selected from Control Noise.

\begin{figure}[htbp]
    \center
    \includegraphics[scale=0.7]{Q5 AW Data.png}
    \caption{Measured data and the modeled responses.}
    \label{figure:q5AWcaseData}
\end{figure}


Figure~\ref{figure:q5ilPlot} shows the transmission loss angles of incidence from 0 to 90$^\circ$ in steps of 10$^\circ$.

\begin{figure}[htbp]
    \center
    \includegraphics[scale=0.9]{Q5 IL Plot.pdf}
    \vspace{-0.5cm}
    \caption{Measured data and the modeled responses.}
